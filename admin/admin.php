...
<td><a href="edit-admin.php?id_admin=<?php echo $row['id_admin']; ?>" class="btn btn-warning">Edit</a>
<a href="hapus-admin.php?id_admin=<?php echo $row['id_admin']; ?>" class="btn btn-danger">Hapus</a>
</td>
</tr>
<?php 
} 
